...
def generate_class_report():
    ...
    with open(REPORT_FILE, "w") as file:
        ...
        file.write(f"Roll: {highest_info['roll_no']}\n")
        file.write(f"Name: {highest_name}\n")
        file.write(f"Department: {highest_info['dept']}\n")
        file.write(f"GPA: {highest_info['gpa']}\n")
        file.write("\n--------------------------------\n\n")
        ...
        file.write("Oldest Student\n\n")
        file.write(f"Roll: {oldest_info['roll_no']}\n")
        file.write(f"Name: {oldest_name}\n")
        file.write(f"Age: {oldest_info['age']}\n")
        file.write("\n--------------------------------\n\n")

        file.write("Youngest Student\n\n")
        file.write(f"Roll: {youngest_info['roll_no']}\n")
        file.write(f"Name: {youngest_name}\n")
        file.write(f"Age: {youngest_info['age']}\n")
        file.write("\n--------------------------------\n\n")
